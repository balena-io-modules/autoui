...
* Support both `react-router-dom` v5 `history` and v6 `navigate` [myarmolinsky]
* Update @balena/ui-shared-components [myarmolinsky]

# v7.2.2
## (2024-12-30)

* Restore minimal logic to retrieve the default lens [Andrea Rosci]

# v7.2.1
## (2024-12-28)

* Fix broken lens getter [Andrea Rosci]

# v7.2.0
## (2024-12-23)

* Simplify lens logic and remove problematic dependencies (archive helper) [Andrea Rosci]

# v7.1.6
## (2024-12-23)

* Fix table select all for client side data when selection is none [Andrea Rosci]
